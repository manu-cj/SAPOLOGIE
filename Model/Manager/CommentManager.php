...
class CommentManager
{
    ...
    {
        $select = Connect::getPDO()->prepare("SELECT * FROM aiu12_comment where character_image_fk = :id ORDER BY date desc");
    ...
    public static function getLastComment(int $id)
    {
        $select = Connect::getPDO()->prepare("SELECT * FROM aiu12_comment where character_image_fk = :id ORDER BY date desc LIMIT 5");
